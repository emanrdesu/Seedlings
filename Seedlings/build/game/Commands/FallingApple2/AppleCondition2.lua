AppleCondition2 = Command:extend()
AppleCondition2.COMMAND_NAME = 'If'

function AppleCondition2:new(args)
  -- Params is the set of things that the user can modify for this command
  if args == nil then args = {} end
  self.params = {
    left = args.left or 'apple',
    op = args.op or '==',
    right = args.right or 'center',
  }
  ...
  self.rightList:add({userString = 'center', codeString = 'center'})
...
function AppleCondition2:toUserString()
...
function AppleCondition2:toLuaStringList()  
...
function AppleCondition2:increaseIndent() return true end