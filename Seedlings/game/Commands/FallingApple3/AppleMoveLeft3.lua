AppleMoveLeft3 = Command:extend()
AppleMoveLeft3.COMMAND_NAME = 'Move Left'

function AppleMoveLeft3:new(args)
...
function AppleMoveLeft3:toUserString()
  local s = "move left "..tostring(self.params.value)
  return s
end

-- Translate to valid lua code
function AppleMoveLeft3:toLuaStringList()  
...
function AppleMoveLeft3:getParamList()
