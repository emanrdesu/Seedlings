...
function ElseIntroductionScene:new()
  ...
  self.textBoxes:addText("One of the boxes is on the left, and the other is on the right. You can shake the boxes to check whether the basebasll is inside it or not.")
  ...
  self.textBoxes:addText("Then after this new set of code, the 'end' statement is added. The code for this example would look like the folling page:")
  ...
  self.textBoxes:addText("The 'else' statement is not always needed, but it can be helpful for situations like above. The next game can be solved with or without it.")
end
